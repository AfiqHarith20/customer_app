const Map<String, String> msMY = {
  ...
  "Friendly, Easy & Effective": "Mesra, Mudah & Efektif",
  ...
  'Please enter vehicle model': 'Sila masukkan model kenderaan',
  'COLOR': 'WARNA',
  "Color*": "Warna*",
  'Color required': 'Warna Diperlukan',
  'VEHICLE MANUFACTURE': 'SYARIKAT KENDERAAN',
  "PRIMARY": "UTAMA",
  "Vehicle Manufacture*": "Syarikat Kenderaan*",
  'Vehicle Manufacture required': 'Syarikat Kenderaan Diperlukan',
  "ADD VEHICLE": "TAMBAH KENDERAAN",
  "Delete Vehicle": "Padam Kenderaan",
  "Are you sure you want to Delete Vehicle.":
      "Adakah anda pasti mahu Padam Kenderaan.",
  "Sorry, no vehicles registered.": "Maaf, tiada kenderaan didaftarkan.",
  'Please enter a valid plate number': 'Sila masukkan nombor plate',
  'Please enter a valid vehicle model': 'Sila masukkan jenis kenderaan',
  'Please select a color': 'Sila pilih warna',
  'Please select a vehicle manufacturer': 'Sila pilih syarikat kenderaan',
  'Vehicle added successfully': 'Kenderaan berjaya didaftarkan',
  'Vehicle updated successfully': 'Kenderaan berjaya diubah',
  'Vehicle deleted successfully': 'Kenderaan berjaya dipadam',
  'As a new user, we would like to let you know that the minimum purchase for the private pass is 3 months. Below are the details:':
      'Sebagai pengguna baru, kami ingin memberitahu anda bahawa pembelian minimum untuk petak khas ialah 3 bulan. Di bawah adalah butirannya:',
  'Start Date:': 'Tarikh Mula:',
  'End Date:': 'Tarikh Tamat:',
  'Price: RM': 'Harga: RM',
  'New User Pass': 'Pas Pengguna Baru',
  "Start Date*": "Tarikh Mula*",
};
