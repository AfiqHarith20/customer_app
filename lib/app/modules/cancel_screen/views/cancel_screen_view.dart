...
class CancelScreenView extends GetView<CancelScreenController> {
  const CancelScreenView({Key? key}) : super(key: key);
      ...
      child: StreamBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
            ...
            return snapshot.data!.docs.isEmpty
                ? Center(
                    child: Constant.showEmptyView(message: "No Canceled Parking Found"),
                  )
                : ListView.builder(
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  ...
                                                  style: const TextStyle(color: AppColors.darkGrey09, fontFamily: AppThemData.semiBold, fontSize: 17),
                                                ),
                                              ),
                                              // Text(
                                              //   Constant.amountShow(
                                          ...
                                          Row(
                                            children: [
                                              SvgPicture.asset(
                                                height: 18,
                                                width: 18,
                                                bookingModel.parkingDetails!.parkingType == "2" ? "assets/icons/ic_bike.svg" : "assets/icons/ic_car.svg",
                                              ),
                                              const SizedBox(
                                                width: 4,
                                              ),
                                              ...
                                              InkWell(
                                                ...
                                                child: const Text(
                                                  "View Details",
                                                  style: TextStyle(fontSize: 13, fontFamily: AppThemData.semiBold, color: AppColors.yellow04),
                                                ),
                                              )
                                            ],
                                          ),
