...
class PurchasePassView extends GetView<PurchasePassController> {
  const PurchasePassView({super.key});
                    ...
                    child: ButtonThem.buildButton(
                      ...
                      onPress: () async {
                        if (controller.formKeyPurchase.value.currentState!
                          ...
                          controller.cleanup();
                          Get.offNamed(Routes.SELECT_PAYMENT_SCREEN,
                              arguments: {
                                "addSeasonPassData":
                                    controller.addSeasonPassData,
                                "purchasePassModel":
                                    controller.purchasePassModel.value,
                                "passId": controller.purchasePassModel.value
                                    .seasonPassModel?.passid,
                                "passName": controller.purchasePassModel.value
                                    .seasonPassModel?.passName,
                                "passPrice": controller.purchasePassModel.value
                                    .seasonPassModel?.price,
                                "passValidity": controller.purchasePassModel
                                    .value.seasonPassModel?.validity,
                              });
                        }
                      },
                    )),
