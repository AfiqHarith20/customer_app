...
class ParkingDetailScreenController extends GetxController {
  ...
  //             id: "",
  //             descriptor: currentLocationMarker!);
  //       }
  //     });
  //   }
  // }
  ...
  //       await Constant().getBytesFromAsset("assets/icons/ic_map_pin.png", 100);
  ...
  double calculateTotalDistance() {
    double totalDistance = Geolocator.distanceBetween(
        ...
        parkingModel.value.location!.latitude!,
        parkingModel.value.location!.longitude!);
